...
/**
 * Defines the [brew,koji]-build.gate.complete message
...
def call(Map parameters = [:]) {
    ...
    def defaults = readJSON text: libraryResource('msgBus-Common-Gate-Complete.json')
    ...
    return { Map runtimeArgs = [:] ->
        ...
        parameters['decision'] = parameters['decision'] ?: msgBusDecisionContent()()
        ...
        try {
            ...
            throw new Exception("Creating the gate complete message failed: " + e)
        }
