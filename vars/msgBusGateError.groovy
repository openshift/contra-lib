...
/**
 * Defines the [brew,koji]-build.gate.error message
...
def call(Map parameters = [:]) {
    ...
    def defaults = readJSON text: libraryResource('msgBus-Common-Gate-Error.json')
    ...
    return { Map runtimeArgs = [:] ->
        ...
        try {
            ...
            throw new Exception("Creating the gate error message failed: " + e)
        }
