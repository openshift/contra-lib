...
/**
 * Defines the [brew-koji]-build-group.build.error message
...
def call(Map parameters = [:]) {
    ...
    def defaults = readJSON text: libraryResource('msgBus-Common-Build-Error.json')
    ...
    return { Map runtimeArgs = [:] ->
        ...
        try {
            ...
            throw new Exception("Creating the build error message failed: " + e)
        }
